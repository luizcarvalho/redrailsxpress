...
case 'imgedit-preview' :
	...
	include_once( ABSPATH . 'administracao/includes/image-edit.php' );
...
case 'menu-quick-search':
	...
	require_once ABSPATH . 'administracao/includes/nav-menu.php';
...
case 'replyto-comment' :
	...
	ob_start();
		if ( 'dashboard' == $_REQUEST['mode'] ) {
			require_once( ABSPATH . 'administracao/includes/dashboard.php' );
