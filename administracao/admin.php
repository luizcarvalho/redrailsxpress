...
require_once(ABSPATH . 'administracao/includes/admin.php');
...
if ( WP_NETWORK_ADMIN )
	require(ABSPATH . 'administracao/network/menu.php');
elseif ( WP_USER_ADMIN )
	require(ABSPATH . 'administracao/user/menu.php');
else
	require(ABSPATH . 'administracao/menu.php');
