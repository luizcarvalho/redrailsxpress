...
/**
 * Core Upgrader class for WordPress. It allows for WordPress to upgrade itself in combination with the administracao/includes/update-core.php file
 *
 * @TODO More Detailed docs, for methods as well.
 *
 * @package WordPress
...
class Core_Upgrader extends WP_Upgrader {
	...
	function upgrade($current) {
		...
		if ( !$wp_filesystem->copy($working_dir . '/wordpress/administracao/includes/update-core.php', $wp_dir . 'administracao/includes/update-core.php', true) ) {
			$wp_filesystem->delete($working_dir, true);
			return new WP_Error('copy_failed', $this->strings['copy_failed']);
		}
		$wp_filesystem->chmod($wp_dir . 'administracao/includes/update-core.php', FS_CHMOD_FILE);

		require(ABSPATH . 'administracao/includes/update-core.php');
