...
function _unzip_file_pclzip($file, $to, $needed_dirs = array()) {
	...
	require_once(ABSPATH . 'administracao/includes/class-pclzip.php');
...
function WP_Filesystem( $args = false, $context = false ) {
	...
	require_once(ABSPATH . 'administracao/includes/class-wp-filesystem-base.php');
	...
	if ( ! class_exists("WP_Filesystem_$method") ) {
		$abstraction_file = apply_filters('filesystem_method_file', ABSPATH . 'administracao/includes/class-wp-filesystem-' . $method . '.php', $method);
