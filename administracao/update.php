...
include_once ABSPATH . 'administracao/includes/class-wp-upgrader.php';
...
if ( isset($_GET['action']) ) {
	...
	if ( 'update-selected' == $action ) {
		...
		require_once(ABSPATH . 'administracao/admin-header.php');
		...
		include_once ABSPATH . 'administracao/includes/plugin-install.php'; //for plugins_api..
		...
		include_once ABSPATH . 'administracao/includes/theme-install.php'; //for themes_api..
