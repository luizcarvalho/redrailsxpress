...
= 2.5.4 =
* Limit Akismet CSS and Javascript loading in administracao to just the pages that need it
* Added author URL quick removal functionality
* Added mShot preview on Author URL hover
* Added empty index.php to prevent directory listing
* Move administracao menu items under Jetpack, if it is installed
...
* Use HTTPS for the stats IFRAME when administracao is using HTTPS
