					...
					for($i = 1; $i <=5; $i++) {
						?>
							<div class="imageElement">
								...
								<p>To set your featured posts, please go to your theme options page in administracao. You can also disable featured posts slideshow if you don't wish to display them.</p>
