...
<p><?php _e('Logged in as','arthemia'); ?> <a href="<?php echo get_option('siteurl'); ?>/administracao/profile.php"><?php echo $user_identity; ?></a>. <a href="<?php echo wp_logout_url(get_permalink()); ?>" title="<?php _e('Log out of this account','arthemia'); ?>"><?php _e('Logout','arthemia'); ?> &raquo;</a></p>
