...
<?php $showgallery1 = get_settings ( "cp_showpostgallery" );
	...
	$showgallery3 = get_settings ( "cp_showindexgallery" );
		  ...
		  if ( (is_home() && $showgallery3 != "no") || (is_search() && $showheadline2 != "no") || (is_archive() && $showgallery2 != "no") || (is_single() && $showgallery1 != "no") ) { ?>
...
<div id="footer"> <?php wp_footer(); ?> <?php _e('Powered by','arthemia'); ?> <a href="http://mhostindia.com/">Mini Infotech</a> | <?php if ( is_user_logged_in() ) { ?> <?php wp_register('', ''); ?> | <?php } ?> <?php wp_loginout(); ?> | <a href="<?php bloginfo('rss2_url'); ?>"><?php _e('Entries (RSS)','arthemia');?></a> | <a href="<?php bloginfo('comments_rss2_url'); ?>"><?php _e('Comments (RSS)','arthemia');?></a> | </a>
