...
<p><?php _e('Logged in as','arthemia'); ?> <a href="<?php echo get_option('siteurl'); ?>/administracao/profile.php"><?php echo $user_identity; ?></a>. <a href="<?php echo get_option('siteurl'); ?>/wp-login.php?action=logout" title="<?php _e('Log out of this account','arthemia'); ?>"><?php _e('Logout','arthemia'); ?> &raquo;</a></p>
...
<p><?php _e('This is a Gravatar-enabled weblog. To get your own globally-recognized-avatar, please register at','arthemia'); ?> <a href="http://www.gravatar.com">Gravatar</a> <a href="http://www.amirariff.com/blog">blog</a>.</p>
