...
if ( $authorised ) {
    ...
    <p><?php printf( __( 'Theme uninstalled. Redirecting to %s', 'graphene' ), '<a href="'.get_home_url().'/administracao/themes.php?activated=true">'.get_home_url().'/administracao/themes.php?activated=true</a>...' ); ?></p>
	<script type="text/javascript">
		window.location = '<?php echo get_home_url(); ?>/administracao/themes.php?activated=true';
	</script>;
	</div>
