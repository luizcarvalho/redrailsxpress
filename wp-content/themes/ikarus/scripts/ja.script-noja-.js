...
function equalHeightInit (){
	...
	var ja_content = document.getElementById ('container');
	var ja_colwrap = document.getElementById ('colwrap');
	if (ja_content && ja_colwrap) {
		if (ja_content.scrollHeight > ja_colwrap.scrollHeight) 
		{
			...
			document.getElementById ('content').style.height = ja_content.scrollHeight + 'px';
		}
	}

	//Bottom spotlight 1
	var ja_botsl = document.getElementById ('botsl1');
	if (ja_botsl)
	{
		var botsl = getElementsByClass ("box.*", ja_botsl, "DIV");	
	...
	//Bottom spotlight 2
	var ja_botsl = document.getElementById ('botsl2');
	if (ja_botsl)
	{
		var botsl = getElementsByClass ("box.*", ja_botsl, "DIV");	
		if (botsl && botsl.length)
