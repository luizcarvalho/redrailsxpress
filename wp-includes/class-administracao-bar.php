...
class WP_Admin_Bar {
	...
	final protected function _render_container( $node ) {
		...
		?><div id="<?php echo esc_attr( 'administracao-bar-' . $node->id ); ?>" class="ab-group-container"><?php
	...
	final protected function _render_group( $node ) {
		...
		?><ul id="<?php echo esc_attr( 'administracao-bar-' . $node->id ); ?>" class="<?php echo esc_attr( $class ); ?>"><?php
	...
	final protected function _render_item( $node ) {
		...
		<li id="<?php echo esc_attr( 'administracao-bar-' . $node->id ); ?>" class="<?php echo esc_attr( $menuclass ); ?>"><?php
			if ( $has_link ):
