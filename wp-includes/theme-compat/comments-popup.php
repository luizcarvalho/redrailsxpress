...
<?php if ( $user_ID ) : ?>
	<p><?php printf(__('Logged in as <a href="%1$s">%2$s</a>. <a href="%3$s" title="Log out of this account">Log out &raquo;</a>'), get_option('siteurl') . '/administracao/profile.php', $user_identity, wp_logout_url(get_permalink())); ?></p>
<?php else : ?>
	<p>
